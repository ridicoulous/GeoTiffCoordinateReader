...
namespace GeoTiffElevationReader
{
    public class GeoTiff
    {
        ...
        public void CropArea(double bottomLeftLat, double bottomLeftLon, double upperRightLat, double upperRightLon, string fileToSave, GeoTiffElevationReader.Struture.RasterOutputType rasterOutputType)
        {
            //box
